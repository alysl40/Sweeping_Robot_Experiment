...
class Counter():
    def __init__(self,canvas):
        ...
        self.canvas.create_text(self.x+200,self.y,text="Garbage capacity: "+str(self.garbage_capacity),tags ="capacity")
...
class Bot:
    ...
    def go_to_bin(self,lightL_to_bin, lightR_to_bin):       # The flowing code is written by myself
    ...
    def brain(self,chargerL,chargerR,lightL_to_bin, lightR_to_bin,count):            # The flowing code is written by myself
        ...
        CHARGE_BATTERY_PRIORITY = 1
        EMPTY_TRASH_PRIORITY = 2
        ...
        if task == "clean_dust":
            ...
            self.go_to_bin(lightL_to_bin, lightR_to_bin)
            pass
    ...
    def move(self,canvas,registryPassives,dt,count):
        ...
        for rr in registryPassives:
            if isinstance(rr,Charger) and self.distanceTo(rr)<80:         # The flowing code is written by myself
                self.battery += 10
        for rr in registryPassives:
