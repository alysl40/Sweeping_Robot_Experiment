...
df = pd.read_excel("D:\诺丁汉大学 学习资料\诺丁汉大学  计算机科学 学习资料\Designing intelligent agent\Coursework\Experiment 2 Priority comparison.xlsx")
...
result_df.to_excel(excel_writer='D:\诺丁汉大学 学习资料\诺丁汉大学  计算机科学 学习资料\Designing intelligent agent\Coursework\Priority_comparison_Result.xlsx',sheet_name='Result')


plt.boxplot([df['Bin'],df['charger']])
plt.title('Experimental data line chart')
plt.xticks([1,2],['Bin','charger'])
plt.ylabel('Dust Collection Quantity')
plt.show()
